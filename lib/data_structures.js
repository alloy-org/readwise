 ...
 */
export function _distributeIntoSmallGroups(app, source, groupSize, trimFunction) {
  let result = {};
...
export function _trimHighlights(_this, app, toPush) {
  let groupMarkdown = _markdownFromHighlights(app)(toPush);

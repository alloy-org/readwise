...
export async function _syncBookHighlights(app, bookNote, readwiseBookID, { readwiseBook = null, throwOnFail = false } = {}) {
  ...
  hlGroups = _distributeIntoSmallGroups(app, hlGroups, this.constants.maxBookHighlightsPerSection, this._trimHighlights);
  let entries = Object.entries(hlGroups);
  entries.sort((a, b) => b[0].localeCompare(a[0]));
  let hlMarkdown = _markdownFromSections(entries, _markdownFromHighlights(app));

...
export async function _writeDashboard(app, noteContents, dashboard, dashboardNote, dashboardConstants) {
  ...
  dashboard = _distributeIntoSmallGroups(app, dashboard, dashboardConstants.maxTableBooksPerSection);
 ...
 */
export async function _updateDashboardDetails(app, dashboard, dashDetailsFieldNames, details, {tableRowCount = null, bookCount = null } = {}) {
  ...
  details[dashDetailsFieldNames.lastSyncedAt] = _localeDateFromIsoDate(app, new Date());
  details[dashDetailsFieldNames.firstUpdated] = _localeDateFromIsoDate(app, earliestUpdatedAt);
  details[dashDetailsFieldNames.lastUpdated] = _localeDateFromIsoDate(app, lastUpdatedAt);

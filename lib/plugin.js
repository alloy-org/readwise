const plugin = {
  ...
  async _ensureBookInDashboardNoteTable(app, dashboardNote, readwiseBook, bookNoteUUID) {
    ...
    this._sortedInsertReadwiseBook(app, existingTable, dashboardNote, readwiseBook, bookNoteUUID);
  ...
  async _sortedInsertReadwiseBook(app, tableContent, dashboardNote, readwiseBook, bookNoteUUID) {
    ...
    if (sectionContent) {
      ...
      console.log("Could not find any content for section", sectionLabel);
      ...
      if (!sectionBeforeLabel) {
        bookListContent = `${ sectionLabel }\n${ tablePreambleContent }${ bookRowContent }\n\n${ existingBookList }\n\n`;
      } else {

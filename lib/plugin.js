const plugin = {
  ...
  async _migrateBooksToSections(app, dashboardNote) {
    ...
    await dashboardNote.replaceContent("", this._sectionFromHeadingText(this.constants.unsortedSectionTitle));
    dashboardBookListMarkdown = this._sectionContent(await dashboardNote.content(), this.constants.dashboardBookListTitle);
    dashboardBookListMarkdown = dashboardBookListMarkdown.replace(new RegExp(`#+\\s${ this.constants.unsortedSectionTitle }[\\r\\n]*`), "")
    await dashboardNote.replaceContent(dashboardBookListMarkdown.trim(), this._sectionFromHeadingText(this.constants.dashboardBookListTitle));

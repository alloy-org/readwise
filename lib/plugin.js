...
import { _sectionsFromMarkdown } from './markdown.js';
...
const plugin = {
  ...
  async _syncAll(app, noteUUID, categoryFilter) {
    ...
    try {
      ...
      let dashboard = await _sectionsFromMarkdown(dashboardNote, this.constants.dashboardBookListTitle, this._tableFromMarkdown);

const plugin = {
  ...
  async _ensureBookInDashboardNoteTable(app, dashboardNote, readwiseBook, bookNoteUUID) {
    ...
    let readwiseTableContent = this._tableContentWithReadwiseBook(app, existingTable, readwiseBook, bookNoteUUID);
  ...
  /*******************************************************************************************/
  _tableContentWithReadwiseBook(app, tableContent, readwiseBook, bookNoteUUID) {
    ...
    const sectionContent = this._sectionContent(tableContent, this.constants.dashboardBookListTitle) || "";
